...
static int parse_env(struct OPENSSL_s390xcap_st *cap, int *cex)
{
    ...
    static const struct OPENSSL_s390xcap_st z990 = {
        /*.stfle  = */ { S390X_CAPBIT(S390X_MSA),
            0UI64, 0UI64, 0UI64 },
        /*.kimd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1), 0UI64 },
        /*.klmd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1), 0UI64 },
        /*.km     = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kmc    = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kmac   = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kmctr  = */ { 0UI64, 0UI64 },
        /*.kmo    = */ { 0UI64, 0UI64 },
        /*.kmf    = */ { 0UI64, 0UI64 },
        /*.prno   = */ { 0UI64, 0UI64 },
    ...
    static const struct OPENSSL_s390xcap_st z9 = {
        /*.stfle  = */ { S390X_CAPBIT(S390X_MSA)
            ...
            0UI64, 0UI64, 0UI64 },
        /*.kimd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1) | S390X_CAPBIT(S390X_SHA_256), 0UI64 },
        /*.klmd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1) | S390X_CAPBIT(S390X_SHA_256), 0UI64 },
        /*.km     = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128), 0UI64 },
        /*.kmc    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128), 0UI64 },
        /*.kmac   = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kmctr  = */ { 0UI64, 0UI64 },
        /*.kmo    = */ { 0UI64, 0UI64 },
        /*.kmf    = */ { 0UI64, 0UI64 },
    ...
    static const struct OPENSSL_s390xcap_st z10 = {
        /*.stfle  = */ { S390X_CAPBIT(S390X_MSA)
                | S390X_CAPBIT(S390X_STCKF),
            0UI64, 0UI64, 0UI64 },
        /*.kimd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1) | S390X_CAPBIT(S390X_SHA_256) | S390X_CAPBIT(S390X_SHA_512), 0UI64 },
        /*.klmd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1) | S390X_CAPBIT(S390X_SHA_256) | S390X_CAPBIT(S390X_SHA_512), 0UI64 },
        /*.km     = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmc    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmac   = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kmctr  = */ { 0UI64, 0UI64 },
        /*.kmo    = */ { 0UI64, 0UI64 },
        /*.kmf    = */ { 0UI64, 0UI64 },
    ...
    static const struct OPENSSL_s390xcap_st z196 = {
        ...
        /*.klmd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1) | S390X_CAPBIT(S390X_SHA_256) | S390X_CAPBIT(S390X_SHA_512), 0UI64 },
        /*.km     = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256) | S390X_CAPBIT(S390X_XTS_AES_128) | S390X_CAPBIT(S390X_XTS_AES_256), 0UI64 },
        /*.kmc    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmac   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmctr  = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmo    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmf    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.prno   = */ { 0UI64, 0UI64 },
        /*.kma    = */ { 0UI64, 0UI64 },
        /*.pcc    = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kdsa   = */ { 0UI64, 0UI64 },
    };
    ...
    static const struct OPENSSL_s390xcap_st z13 = {
        ...
        /*.kmo    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmf    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.prno   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_512_DRNG), 0UI64 },
        /*.kma    = */ { 0UI64, 0UI64 },
        /*.pcc    = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kdsa   = */ { 0UI64, 0UI64 },
    };
    ...
    static const struct OPENSSL_s390xcap_st z14 = {
        ...
        /*.klmd   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1) | S390X_CAPBIT(S390X_SHA_256) | S390X_CAPBIT(S390X_SHA_512) | S390X_CAPBIT(S390X_SHA3_224) | S390X_CAPBIT(S390X_SHA3_256) | S390X_CAPBIT(S390X_SHA3_384) | S390X_CAPBIT(S390X_SHA3_512) | S390X_CAPBIT(S390X_SHAKE_128) | S390X_CAPBIT(S390X_SHAKE_256), 0UI64 },
        /*.km     = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256) | S390X_CAPBIT(S390X_XTS_AES_128) | S390X_CAPBIT(S390X_XTS_AES_256), 0UI64 },
        /*.kmc    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmac   = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.kmctr  = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        ...
        /*.kma    = */ { S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) | S390X_CAPBIT(S390X_AES_256), 0UI64 },
        /*.pcc    = */ { S390X_CAPBIT(S390X_QUERY), 0UI64 },
        /*.kdsa   = */ { 0UI64, 0UI64 },
    };
